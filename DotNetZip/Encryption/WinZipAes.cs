...
namespace CipherBox.Zip.Encryption
{
    ...
    internal class WinZipAesCrypto
    {
            ...
            set
            {
                ...
                if (_Password != null)
                {
                    ...
                    if (PasswordVerificationGenerated != PasswordVerificationStored)
                        throw new CipherBox.Zip.BadPasswordException();
                }
            }
            private get
            {
        ...
        public void ReadAndVerifyMac(System.IO.Stream s)
        {
            ...
            if (invalid)
                throw new CipherBox.Zip.BadStateException("The MAC does not match.");
        }
    ...
    internal class WinZipAesCipherStream : Stream
    {
        ...
        internal ICryptoTransform _encryptor;
            ...
            : base()
        {
            ...
            // It is reflexive.
            _encryptor = _aesCipher.CreateEncryptor(_params.KeyBytes, iv);
        ...
        private void WriteTransformOneBlock(byte[] buffer, int offset)
        {
            ...
            _encryptor.TransformBlock(counter,
                                  0,
                                  BLOCK_SIZE_IN_BYTES,
                                  counterOut,
                                  0);
        ...
        private void WriteTransformFinalBlock()
        {
            ...
            System.Array.Copy(BitConverter.GetBytes(_nonce++), 0, counter, 0, 4);
            counterOut = _encryptor.TransformFinalBlock(counter,
                                                    0,
                                                    BLOCK_SIZE_IN_BYTES);
