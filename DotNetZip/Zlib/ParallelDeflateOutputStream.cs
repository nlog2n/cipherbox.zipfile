...
using CipherBox.Zip.Zlib;
using System.IO;


namespace CipherBox.Zip.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        CipherBox.Zip.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="CipherBox.Zip.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="CipherBox.Zip.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private CipherBox.Crc.CRC32             _runningCrc;
        ...
        private CipherBox.Zip.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="CipherBox.Zip.Zlib.DeflateStream"/>,
        ...
        ///   cref="CipherBox.Zip.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new CipherBox.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="CipherBox.Zip.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    CipherBox.Zip.Zlib.CRC32 c= new CipherBox.Zip.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                CipherBox.Crc.CRC32 crc = new CipherBox.Crc.CRC32();
