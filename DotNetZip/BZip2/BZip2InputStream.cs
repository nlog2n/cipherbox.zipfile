...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:CipherBox.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace CipherBox.Zip.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly CipherBox.Crc.CRC32 crc = new CipherBox.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new CipherBox.BZip2.BZip2InputStream(fs))
        ///       {
