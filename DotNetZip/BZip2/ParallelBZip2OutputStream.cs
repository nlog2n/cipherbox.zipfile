...
namespace CipherBox.Zip.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="CipherBox.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="CipherBox.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new CipherBox.BZip2.ParallelBZip2OutputStream(output))
        ///           {
