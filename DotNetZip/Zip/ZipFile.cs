// ZipFile.cs
//
// A zipfile class library reads and writes zip files, according to the format
...
namespace CipherBox.Zip
{
    ...
    ///   DotNetZip in the classes in the CipherBox.Zip.Zlib namespace.
    /// </para>
    ///
    /// <para>
    ...
    public partial class ZipFile :    System.Collections.IEnumerable, System.Collections.Generic.IEnumerable<ZipEntry>, IDisposable
    {
        ...
        ///   information see <see
        ///   cref="CipherBox.Zip.Zlib.CompressionStrategy">CipherBox.Zip.Zlib.CompressionStrategy</see>.
        /// </remarks>
        public CipherBox.Zip.Zlib.CompressionStrategy Strategy
        {
        ...
        ///  </para>
        /// </remarks>
        public CipherBox.Zip.Zlib.CompressionLevel CompressionLevel
        {
            get;
            set;
        }
        ...
        ///   </para>
        /// </remarks>
        /// <seealso cref="CipherBox.Zip.CompressionMethod" />
        public CipherBox.Zip.CompressionMethod CompressionMethod
        {
            get
            {
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = CipherBox.Zip.ZipFile.DefaultEncoding;
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.DefaultEncoding">DefaultEncoding</seealso>
        ...
        /// known as IBM437.
        /// </summary>
        /// <seealso cref="CipherBox.Zip.ZipFile.ProvisionalAlternateEncoding"/>
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.Encryption">ZipFile.Encryption</seealso>
        /// <seealso cref="CipherBox.Zip.ZipEntry.Password">ZipEntry.Password</seealso>
        ...
        /// </para>
        /// </remarks>
        /// <seealso cref="CipherBox.Zip.ZipEntry.ExtractExistingFile"/>
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.ZipErrorAction"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.ZipError"/>
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.Password">ZipFile.Password</seealso>
        /// <seealso cref="CipherBox.Zip.ZipEntry.Encryption">ZipEntry.Encryption</seealso>
        ...
        ///   <c>CipherBox.Zip.Zlib.CompressionLevel.None</c> means no compression will be used.
        /// </para>
        ///
        /// <para>
        ...
        ///     cref="CipherBox.Zip.Zlib.CompressionLevel.BestSpeed"/>.  You may have to
        ...
        /// </remarks>
        ///
        /// <exception cref="CipherBox.Zip.ZipException">
        ...
        private void _InitInstance(string zipFileName, TextWriter statusMessageWriter)
        {
            ...
            CompressionLevel = CipherBox.Zip.Zlib.CompressionLevel.Default;
        ...
        /// </code>
        /// </example>
        /// <seealso cref="CipherBox.Zip.ZipFile.RemoveEntry(string)"/>
        ///
        ...
        /// </remarks>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.this[string]"/>
        ///
        /// <example>
        ...
        /// </param>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.RemoveSelectedEntries(string)"/>
        ///
        ...
        private CipherBox.Zip.Zlib.CompressionStrategy _Strategy = CipherBox.Zip.Zlib.CompressionStrategy.Default;
        private CipherBox.Zip.CompressionMethod _compressionMethod = CipherBox.Zip.CompressionMethod.Deflate;
        ...
        internal CipherBox.Zip.Zlib.ParallelDeflateOutputStream ParallelDeflater;
