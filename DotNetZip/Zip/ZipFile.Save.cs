...
namespace CipherBox.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="CipherBox.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new CipherBox.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= CipherBox.Zip.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = CipherBox.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = CipherBox.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
