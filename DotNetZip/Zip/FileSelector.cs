...
namespace CipherBox.Zip.Filter
{
    ...
    ///   cref="CipherBox.Zip.ZipFile.AddSelectedFiles(String,String)"/> method, or one of
    ///   its overloads, is called.  It's also used for the <see
    ///   cref="CipherBox.Zip.ZipFile.ExtractSelectedEntries(String)"/> methods.  Typically, an
