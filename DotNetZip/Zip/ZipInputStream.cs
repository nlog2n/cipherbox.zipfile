...
// reading zip files.  This class does not depend on CipherBox.Zip.ZipFile, but rather
    ...
    public class ZipInputStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                CipherBox.Zip.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private CipherBox.Crc.CrcCalculatorStream _crcStream;
