...
namespace CipherBox.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="CipherBox.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="CipherBox.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="CipherBox.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="CipherBox.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="CipherBox.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="CipherBox.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (CipherBox.Zip.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As CipherBox.Zip.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="CipherBox.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public CipherBox.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public CipherBox.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal CipherBox.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new CipherBox.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is CipherBox.Zip.Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                CipherBox.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new CipherBox.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new CipherBox.Zip.Zlib.DeflateStream(input2, CipherBox.Zip.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new CipherBox.Zip.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = CipherBox.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
