...
namespace CipherBox.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = CipherBox.Zip.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = CipherBox.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="CipherBox.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)CipherBox.Zip.CompressionMethod.None)
                    _CompressionLevel = CipherBox.Zip.Zlib.CompressionLevel.None;
                else if (CompressionLevel == CipherBox.Zip.Zlib.CompressionLevel.None)
                    _CompressionLevel = CipherBox.Zip.Zlib.CompressionLevel.Default;
        ...
        public CipherBox.Zip.Zlib.CompressionLevel CompressionLevel
        {
            ...
            set
            {
                ...
                if (value == CipherBox.Zip.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == CipherBox.Zip.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == CipherBox.Zip.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) CipherBox.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) CipherBox.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipEntry.Encryption"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="CipherBox.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="CipherBox.Zip.ZipFile.ZipErrorAction"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = CipherBox.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new CipherBox.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new CipherBox.Zip.ZipException("The filename must be non-null and non-empty.");
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                CipherBox.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private CipherBox.Zip.Zlib.CompressionLevel _CompressionLevel;
