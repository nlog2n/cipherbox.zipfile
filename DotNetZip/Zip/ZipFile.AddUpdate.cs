...
namespace CipherBox.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddItem(string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        ///
        /// using(CipherBox.Zip.ZipFile zip = new CipherBox.Zip.ZipFile())
        /// {
        ...
        /// </remarks>
        ///
        /// <seealso cref="CipherBox.Zip.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="CipherBox.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
