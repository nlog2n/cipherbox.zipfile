...
namespace CipherBox.Zip
{
    ...
    ///   cref="CipherBox.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="CipherBox.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="CipherBox.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="CipherBox.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="CipherBox.Zip.ZipFile.SetCompression"/>
    public delegate CipherBox.Zip.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
