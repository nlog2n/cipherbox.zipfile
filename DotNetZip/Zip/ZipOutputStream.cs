...
// generating zip files.  This class does not depend on CipherBox.Zip.ZipFile, but rather
...
namespace CipherBox.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = CipherBox.Zip.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
        ...
        ///   cref="CipherBox.Zip.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = CipherBox.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="CipherBox.Zip.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private CipherBox.Crc.CrcCalculatorStream _entryOutputStream;
    ...
    internal class ZipContainer
    {
        ...
        public CipherBox.Zip.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
